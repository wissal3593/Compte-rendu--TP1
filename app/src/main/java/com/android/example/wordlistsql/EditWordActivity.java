...
public class EditWordActivity extends AppCompatActivity {
    ...
    /**
     * Click handler for the Save button. Creates a new intent for the reply, adds the reply message
     * to it as an extra, sets the intent result, and closes the activity.
     */
